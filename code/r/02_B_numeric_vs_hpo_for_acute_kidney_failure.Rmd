...
ggsave(filename = 'cache/kidney_labs_raw_data_distribution_by_rel_date.png', plot = p, width = 6, height = 6)
```

![liver function labs](./cache/kidney_labs_raw_data_distribution_by_rel_date.png)
...
write.csv(kidney_analysis, file = 'cache/acute_kidney_failure_analysis.csv', row.names = FALSE)
