...
patient_race_sex_distribution <- get_patient_race_sex_distribution(force_rerun = FORCE_RERUN)
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_by_sex.png'), glue('{OUT_DIR}/plot_by_sex.pdf')), plot = plot_by_sex, width = 2.5, height = 2.5)
plot_by_sex
```
...
ggsave2(filenames = c(glue("{OUT_DIR}/plotByRace.png"), glue("{OUT_DIR}/plotByRace.pdf")), plot = plot_by_race, width = 5, height = 2)
plot_by_race
```
Fraction of each race:
```{r}
countByRace_Gender %>% 
  group_by(race) %>% 
  summarise(n = sum(n)) %>%
...
patient_birth_year_sex_distribution <- get_patient_birth_year_distribution(force_rerun = FORCE_RERUN)
...
ggsave2(filenames = c(glue("{OUT_DIR}/plotByBirthyearSex.png"), glue("{OUT_DIR}/plotByBirthyearSex.pdf")), plot = plot_by_birth_year_sex, width = 4, height = 3)
...
ggsave2(filenames = c(glue("{OUT_DIR}/plotByPhenotypesPerPatient.png"), glue("{OUT_DIR}/plotByPhenotypesPerPatient.pdf")), plot = plot_by_phenotypes_per_patient, width = 3, height = 2)
...
plot_by_distinct_abnormal_hpo_infer_per_patient <- ggplot(hpo_counts_per_patient) +
  ...
  theme(panel.grid = element_blank(),
        axis.title = element_text(size = 8), axis.text = element_text(size = 8), 
        legend.text = element_text(size = 8), legend.title = element_text(size = 10))
ggsave2(filenames = c(glue("{OUT_DIR}/plotByDistinctAbnormalPhenotypeInferPerPatient.png"), glue("{OUT_DIR}/plotByDistinctAbnormalPhenotypeInferPerPatient.pdf")), plot = plot_by_distinct_abnormal_hpo_infer_per_patient, width = 3, height = 2)
...
write.csv(patient_lab_phenotype_journeys_formated, file = glue('{OUT_DIR}/patient_lab_phenotype_journey_formatted.csv'))
```
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_abnormal_phenotypes_by_year_level_1.png'), glue('{OUT_DIR}/plot_abnormal_phenotypes_by_year_level_1.pdf')), plot = p, width = 8, height = 4)
p
```
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_abnormal_phenotypes_by_year_level_1_normalized.png'), glue('{OUT_DIR}/plot_abnormal_phenotypes_by_year_level_1_normalized.pdf')), plot = p, width = 8, height = 4)
p
```
...
write.csv(trendline_lm_test_formatted, file = glue('{OUT_DIR}/table_abnormal_phenotypes_by_year_level_1_normalized_trendline_lm_model.csv'), row.names=FALSE)
...
```{r}
tested_phenotype_rank_direct %>% head(10)
```
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_tested_phenotypes_by_year_level_1.png'), glue('{OUT_DIR}/plot_tested_phenotypes_by_year_level_1.pdf')), plot = p, width = 8, height = 4)
p
```
```{r}
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_tested_phenotypes_by_year_level_1_normalized.png'), glue('{OUT_DIR}/plot_tested_phenotypes_by_year_level_1_normalized.pdf')), plot = p, width = 8, height = 4)
p
```
...
write.csv(trendline_lm_test_formatted, file = glue('{OUT_DIR}/table_tested_phenotypes_by_year_level_1_normalized_trendline_lm_model.csv'), row.names=FALSE)
...
write.csv(racial_abnormality_fisher, file = glue('{OUT_DIR}/racial_abnormality_fisher.csv'), row.names = FALSE)
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_by_phenotype_racial_difference_over_years.png'), glue('{OUT_DIR}/plot_by_phenotype_racial_difference_over_years.pdf')), plot = p, width = 8, height = 8)
...
write.csv(racial_tested_abnormality_fisher, file = glue('{OUT_DIR}/racial_tested_abnormality_fisher.csv'), row.names = FALSE)
...
ggsave2(filenames = c(glue('{OUT_DIR}/plot_by_tested_phenotype_racial_difference_over_years.png'), glue('{OUT_DIR}/plot_by_tested_phenotype_racial_difference_over_years.pdf')), plot = p, width = 8, height = 8)
...
write.csv(overly_tested_abnormalities_by_each_race_top10, file=glue('{OUT_DIR}/overly_tested_abnormalities_by_each_race_top10.csv'), row.names = FALSE)
  ...
  nest() %>% {
    walk2(.$race, .$data, 
          function(race_name, df) sjPlot::tab_df(df, 
                                                 ...
                                                 use.viewer = FALSE, 
                                                 file = glue('{OUT_DIR}/table_overly_tested_abnormalities_for_{race_name}_top10.html')))
  }
