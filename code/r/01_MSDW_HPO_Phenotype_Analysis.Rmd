...
ggsave(filename = glue('{CACHE_DIR}/plot_by_sex.pdf'), plot = plot_by_sex, width = 2.5, height = 2.5)
plot_by_sex
```
...
ggsave(filename = glue("{CACHE_DIR}/plotByRace.pdf"), plot = plot_by_race, width = 5, height = 2)
plot_by_race
```
...
ggsave(filename = glue("{CACHE_DIR}/plotByBirthyearSex.pdf"), plot = plot_by_birth_year_sex, width = 4, height = 3)
