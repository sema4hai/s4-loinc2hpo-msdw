...
ggsave(filename = glue('{CACHE_DIR}/liver_labs_raw_data_distribution_by_rel_date.png', plot = p, width = 6, height = 6))
```
...
write.csv(liver_analysis, file = glue('{CACHE_DIR}/liver_analysis.csv'), row.names = FALSE)
