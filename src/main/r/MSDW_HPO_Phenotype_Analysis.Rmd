...
loinc2hpo_success_metric <- get_loinc2hpo_success_metric(TRUE)
...
hpo_counts_per_patient <- get_hpo_counts_per_patient(TRUE)
...
racial_abnormality_fisher %>% filter(between(lab_year, 2000, 2019)) %>% 
