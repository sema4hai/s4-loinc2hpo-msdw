...
df_control_labs <- get_df_from_db_or_cache(cache_dir = CACHE_DIR, file_name = 'labs_colorectal_cancer_sampled_controls.csv', db_access_callback = dbGetQuery, conn = dsca, statement = sql, force_rerun = TRUE)
```
