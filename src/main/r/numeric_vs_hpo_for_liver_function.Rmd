...
df_cohort <- get_df_from_db_or_cache(cache_dir = CACHE_DIR, file_name = 'liver_diagnoses.csv', db_access_callback = dbGetQuery, conn = dsca, statement = sql, force_rerun = FALSE)
...
df_liver_labs <- get_df_from_db_or_cache(cache_dir = CACHE_DIR, file_name = "labs_liver_function.csv", db_access_callback = dbGetQuery, conn=dsca, statement = sql, force_rerun = FALSE)
df_liver_labs %>% nrow()
```
