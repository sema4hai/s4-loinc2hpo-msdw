...
df_labs <- get_df_from_db_or_cache(cache_dir = CACHE_DIR, file_name = "labs_acute_kidney_failure.csv", db_access_callback = dbGetQuery, conn=dsca, statement = sql, force_rerun = FALSE)
df_labs %>% nrow()
```
