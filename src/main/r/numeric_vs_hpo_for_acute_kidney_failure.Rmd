...
df_cohort <- get_df_from_db_or_cache(cache_dir = CACHE_DIR, file_name = 'acute_kidney_failure_diagnoses.csv', db_access_callback = dbGetQuery, conn = dsca, statement = sql, force_rerun = FALSE)
